...
- The current directory contains a `sfdx-project.json` file
- The current directory contains a `.sf` directory
...
| `detect_folders`    | `['.sf']`                            | Which folders should trigger this module.                                 |
| `style`             | `'bold blue'`                        | The style for the module.                                                 |
